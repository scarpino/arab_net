...
genes_winter <- read.csv("../data/Splitting Drought/Winter GxE.csv")
genes_spring <- read.csv("../data/Splitting Drought/Spring GxE.csv")

genes <- c(as.character(genes_winter[,1]), as.character(genes_spring[,1]))
genes <- unique(genes)
